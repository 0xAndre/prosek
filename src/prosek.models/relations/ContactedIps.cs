...
namespace prosek.models.relations
{
    ...
    public class ArcSightThreatIntelligence
    {
        public string category { get; set; }
        public string result { get; set; }
        public string method { get; set; }
    ...
    {
        public List<string> certificate_policies { get; set; }
    ...
    public class LastAnalysisResults
    {
        ...
        [JsonProperty("ArcSight Threat Intelligence")]
        public ArcSightThreatIntelligence ArcSightThreatIntelligence { get; set; }
        ...
        public XcitiumVerdictCloud XcitiumVerdictCloud { get; set; }
        ...
        public AlphaSOC AlphaSOC { get; set; }
        ...
        public Segasec Segasec { get; set; }
        ...
        public CrowdSec CrowdSec { get; set; }
        public Cluster25 Cluster25 { get; set; }
        public SOCRadar SOCRadar { get; set; }
        ...
        [JsonProperty("Criminal IP")]
        public CriminalIP CriminalIP { get; set; }
    ...
    public class XcitiumVerdictCloud
    {
        public string category { get; set; }
        public string result { get; set; }
        public string method { get; set; }
